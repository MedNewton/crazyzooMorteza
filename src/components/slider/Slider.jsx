...
const Slider = (props) => {
  ...
  useEffect(() => {
    ...
    typewriter.pauseFor(100).typeString("WELCOME TO<br />CRAZY ZOO").start();
  }, []);
  ...
  return (
    ...
    <div className="heroSection">
      <div className="heroTextWrapper" id="heroTextWrapper"></div>
      <h5 className="heroSubtitle">
        The world of NFT
        <br />
        pets
      </h5>
      <div className="mobileOnlyBtns">
      ...
      >
        <Marquee speed={0.15} direction={"left"} delay={3000}>
          LEMUR &#x2022; GORILLA &#x2022; RHINO &#x2022; LEMUR &#x2022; GORILLA
          &#x2022; RHINO &#x2022; LEMUR &#x2022; GORILLA &#x2022; RHINO &#x2022;
          LEMUR &#x2022; GORILLA &#x2022; RHINO &#x2022; LEMUR &#x2022; GORILLA
          &#x2022; RHINO &#x2022; LEMUR &#x2022; GORILLA &#x2022; RHINO &#x2022;
          LEMUR &#x2022; GORILLA &#x2022; RHINO &#x2022;
        </Marquee>
